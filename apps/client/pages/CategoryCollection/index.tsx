...
const mediaSizes = {
    ...
    1366: { slidesPerView: 4.2, spaceBetween: 20 }
}
            ...
            <Collection.Container key={key}>
                ...
                >
                    {category.trips.map((trip, key) => (
                        <SwiperSlide key={key} >
                            <EventCard key={key} data={trip} category={category} image={'https://picsum.photos/id/' + Math.floor(Math.random() * 500) + '/500/350.jpg'} />
                        </SwiperSlide>
                    ))}
                </Swiper>
