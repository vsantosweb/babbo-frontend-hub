    ...
    return (
        <Styled.CardEvent title={event.name}>
            <Styled.CardEventImageContainer>
                <Styled.CardEventImage alt={event.name} src={`${event.event_image}.jpg`} />event_date
            </Styled.CardEventImageContainer>
            <Styled.CardEventBody>
                <Styled.CardEventDetails>
                    <Styled.CardEventDateInfo>
                        <Styled.CardEventMutedText style={{ color: theme.colors.primary }}> {event_date.partial} </Styled.CardEventMutedText>
                    </Styled.CardEventDateInfo>
