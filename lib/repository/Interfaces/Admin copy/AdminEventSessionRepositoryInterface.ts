 ...
 */
export interface AdminEventSessionRepositoryInterface {
    /**
    * Recupera uma lista de recursos.
     ...
     */
    create(formData: Record<string, any>, eventId: number): Promise<any>;
     ...
     */
    update(payload: Record<string, any>, eventId: number, sessionId: number): Promise<any>;
