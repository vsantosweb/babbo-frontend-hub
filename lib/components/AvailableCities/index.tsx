...
export function AvailableCities({ callback }: { callback?: () => any }) {
    ...
    useEffect(() => {
        ...
        eventService.availableCities().then((response: AxiosResponse) => {
                    ...
                    <ModalBody pb={8}>
                        <Stack spacing={4}>
                            ...
                            <Stack spacing={2}>
                                ...
                                {
                                    availableCities.map((city: any, index) => <Flex key={index}
                                        p={2}
